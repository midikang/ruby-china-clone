class Cpanel::TopicsController < Cpanel::ApplicationController
  ...
  def destroy
    @topic.destroy
    respond_to do |format|
      format.html { redirect_to cpanel_topics_path, notice: 'Topic was successfully destroyed.' }
  ...
  private
    ...
    def topic_params
      params.require(:topic).permit(:title, :node_id, :body, :user_id, :replies_count, :last_reply_user_id, :replied_at, :source)
    end
end
